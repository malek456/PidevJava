...
public class UserController {
    ...
    @FXML
    private void handleCodeOptButton(ActionEvent event) throws SQLException, IOException {
        User user = getTextfieldReg();
    ...
    private User getTextfieldReg() {
        ...
        User user = new User(email,nom,prenom,password,phoneNumber,rolesJson,false,createdAt);
        return user;
    }
    ...
    @FXML
    public void handleLoginButton(ActionEvent event) throws SQLException, NoSuchAlgorithmException, IOException {
        login();
    }
    private void redirectToAdminDashboard() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/edu/esprit/projecthope/dashAdmin.fxml"));
    ...
    private void redirectToFrontend() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/edu/esprit/projecthope/front.fxml"));
        stage.getScene().setRoot(fxmlLoader.load());
        stage.setTitle("Acceuil");
    }

    @FXML
    private void handleButtonforgetPassword(ActionEvent event)
    {
        slideOut(loginForm);
        slideIn(EmailForget);
        isLoginFormVisible = false;
    ...
    @FXML
    private void sendCodeButton(ActionEvent event) throws SQLException {
    ...
    @FXML
    private void handleSubmitRestButton(ActionEvent event) throws SQLException, NoSuchAlgorithmException {
    ...
    @FXML
    private void handleCodeRestButton(ActionEvent event)
    {
