...
// Récupère l'objet event correspondant en fonction de eventid
                Event event = getEventById(eventId);
// En supposant que vous ayez un constructeur pour la classe Commentaire qui prend des instances de evenr et User
    ...
    private Event getEventById(int eventId) throws SQLException {
        ...
        if (rs.next()) {
// Crée et renvoie un objet utilisateur basé sur les valeurs ResultSet
